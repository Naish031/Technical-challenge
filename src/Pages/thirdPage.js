...
const thirdPage = () => {
  return (
    <div className="bg-black w-full py-12 lg:py-36 flex flex-row justify-center">
      ...
      {/* <div className="w-1/2 flex justify-center mx-4">
      ...
      <div className=" w-full lg:w-1/2 mx-4">
        <h1 className="text-white text-4xl lg:text-6xl font-bold text-center">
          Lorem{" "}
          <span className="text-transparent bg-gradient-to-r bg-clip-text from-[#3FE0FF] to-[#A060AE]">
            {" "}
            <br /> ipsum!
          </span>
        </h1>
        <div className="lg:w-3/4">
          <p className="text-gray-300 text-center text-sm lg:text-lg mb-10 pt-5">
          ...
          <p className="hidden text-gray-300 text-lg mb-10">
            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
            nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in
            reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
        ...
        {/* WEBSITE BUTTON */}
        <button className=" hidden rounded-full bg-gradient-to-r from-purple-700 to-cyan-400 text-center text-white text-lg px-8 py-4 font-bold ml-2 ">
          Get Started
